# -*- coding: utf-8 -*-
"""
Created on Tue Aug 30 16:58:58 2022

@author: Suraj Gusain
"""
import cv2
import datetime
cap = cv2.VideoCapture("D:\dancevideo.mp4")  #for warn 0 just pass cv2.CAP_DSHOW
...
while(cap.isOpened()):
    ...
    if ret == True:
       ...
       cv2.rectangle(frame, (60, 10), (120, 128), (128, 0, 255), 8)
